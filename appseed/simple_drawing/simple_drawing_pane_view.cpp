...
namespace simple_drawing
{
   ...
   void pane_view::on_show_view()
   {
      ...
      if (get_pane_by_id(::simple_drawing::PaneViewMenu) != NULL && get_pane_by_id(::simple_drawing::PaneViewMenu)->m_pholder != NULL)
      {

         get_pane_by_id(::simple_drawing::PaneViewMenu)->m_pholder->ShowWindow(SW_HIDE);
